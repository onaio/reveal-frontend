          ...
          return (
            <Form
              ...
              onChange={(e: FormEvent) => {
                handlePlanTitleChange(e, formProps);
              }}
              className="mb-5"
            >
                        ...
                        <div className="card-body">
                          <fieldset key={`fieldset${arrItem.actionCode}-${index}`}>
                            ...
                            <FormGroup hidden={hiddenFields.includes('activityActionReason')}>
                              <Label for={`activities-${index}-actionReason`}>
                                {REASON_HEADER}
                              </Label>
                              <Field
                                component="select"
                            ...
                            <fieldset>
                              ...
                              <FormGroup hidden={hiddenFields.includes('activityGoalValue')}>
                                <Label for={`activities-${index}-goalValue`}>
                                  {QUANTITY_LABEL}
                                </Label>
                              ...
                              <FormGroup
                                hidden={hiddenFields.includes('activityTimingPeriodStart')}
                              >
                              ...
                              <FormGroup hidden={hiddenFields.includes('activityTimingPeriodEnd')}>
                                <Label for={`activities-${index}-timingPeriodEnd`}>
                                  {END_DATE}
                                </Label>
                                <Field
                                  type="date"
