...
export const OPENSRP_ORG_PRACTITIONERS_ENDPOINT = 'organization/practitioners';
export type OPENSRP_ORG_PRACTITIONERS_ENDPOINT = typeof OPENSRP_ORG_PRACTITIONERS_ENDPOINT;
