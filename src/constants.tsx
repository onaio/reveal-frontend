...
export const IRS_PLAN_COMPLETION_URL = `/intervention/irs/complete`;
export type IRS_PLAN_COMPLETION_URL = typeof IRS_PLAN_COMPLETION_URL;
...
export const FI_HISTORICAL = 'Historical FI';
