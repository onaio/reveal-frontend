...
export const SHOW_SCHOOL_REPORT_LABEL = process.env.REACT_APP_SHOW_SCHOOL_REPORT_LABEL === 'true';
export type SHOW_SCHOOL_REPORT_LABEL = typeof SHOW_SCHOOL_REPORT_LABEL;
