...
export const HIDE_PLAN_FORM_FIELDS_ON_INTERVENTIONS = (
  process.env.REACT_APP_HIDE_PLAN_FORM_FIELDS_ON_INTERVENTIONS || ''
).split(',');
export type HIDE_PLAN_FORM_FIELDS_ON_INTERVENTIONS = typeof HIDE_PLAN_FORM_FIELDS_ON_INTERVENTIONS;
