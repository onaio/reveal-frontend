...
export const SUPERSET_MDA_LITE_REPORTING_WARD_COLUMNS =
  process.env.REACT_APP_SUPERSET_MDA_LITE_REPORTING_WARD_COLUMNS || 'mdaLitewardColumns';
export type SUPERSET_MDA_LITE_REPORTING_WARD_COLUMNS = typeof SUPERSET_MDA_LITE_REPORTING_WARD_COLUMNS;
