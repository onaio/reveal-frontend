...
export const SUPERSET_MDA_LITE_REPORTING_INDICATOR_ROWS =
  process.env.REACT_APP_SUPERSET_MDA_LITE_REPORTING_INDICATOR_ROWS || 'kenya2021';
export type SUPERSET_MDA_LITE_REPORTING_INDICATOR_ROWS = typeof SUPERSET_MDA_LITE_REPORTING_INDICATOR_ROWS;

export const SUPERSET_MDA_LITE_REPORTING_INDICATOR_STOPS =
  process.env.REACT_APP_SUPERSET_MDA_LITE_REPORTING_INDICATOR_STOPS || 'kenya2021';
...
export const HIDE_PLAN_FORM_FIELDS_ON_CREATE = (
  process.env.REACT_APP_HIDE_PLAN_FORM_FIELDS_ON_CREATE || ''
).split(',');
...
export const CASE_TRIGGERED_DRAFT_EDIT_ADD_ACTIVITIES =
  process.env.REACT_APP_CASE_TRIGGERED_DRAFT_EDIT_ADD_ACTIVITIES === 'true';
