...
export const SUPERSET_IRS_REPORTING_LOWER_JURISDICTIONS_COLUMNS =
  process.env.REACT_APP_SUPERSET_IRS_REPORTING_LOWER_JURISDICTIONS_COLUMNS || '';
export type SUPERSET_IRS_REPORTING_LOWER_JURISDICTIONS_COLUMNS = typeof SUPERSET_IRS_REPORTING_LOWER_JURISDICTIONS_COLUMNS;
...
export const PLAN_TYPES_WITH_MULTI_JURISDICTIONS =
  process.env.REACT_APP_PLAN_TYPES_WITH_MULTI_JURISDICTIONS || 'IRS,Dynamic-IRS';
