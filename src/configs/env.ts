...
export const SUPERSET_MDA_POINT_SCHOOL_REPORT_DATA =
  process.env.REACT_APP_SUPERSET_MDA_POINT_SCHOOL_REPORT_DATA || '';
export type SUPERSET_MDA_POINT_SCHOOL_REPORT_DATA = typeof SUPERSET_MDA_POINT_SCHOOL_REPORT_DATA;
