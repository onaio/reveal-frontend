...
export const ENABLE_IRS_MOP_PUP_REPORTING = process.env.REACT_APP_ENABLE_IRS_MOP_PUP_REPORTING;
export type ENABLE_IRS_MOP_PUP_REPORTING = typeof ENABLE_IRS_MOP_PUP_REPORTING;
