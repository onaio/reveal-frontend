...
export const SUPERSET_IRS_REPORTING_JURISDICTIONS_DATA_SLICE =
  process.env.REACT_APP_SUPERSET_IRS_REPORTING_JURISDICTIONS_DATA_SLICE || '0';
export type SUPERSET_IRS_REPORTING_JURISDICTIONS_DATA_SLICE = typeof SUPERSET_IRS_REPORTING_JURISDICTIONS_DATA_SLICE;
