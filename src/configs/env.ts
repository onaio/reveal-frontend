...
/** Do you want to enable IRS Lite Performance Reporting */
export const ENABLE_IRS_LITE_PERFORMANCE_REPORT =
  process.env.REACT_APP_ENABLE_IRS_LITE_PERFORMANCE_REPORT === 'true';
export type ENABLE_IRS_LITE_PERFORMANCE_REPORT = typeof ENABLE_IRS_LITE_PERFORMANCE_REPORT;
...
export const SUPERSET_IRS_LITE_REPORTING_INDICATOR_STOPS =
  process.env.REACT_APP_SUPERSET_IRS_LITE_REPORTING_INDICATOR_STOPS || 'zambia2019';
...
export const SUPERSET_IRS_LITE_REPORTING_INDICATOR_ROWS =
  process.env.REACT_APP_SUPERSET_IRS_LITE_REPORTING_INDICATOR_ROWS || 'zambia2019';
...
export const SUPERSET_IRS_LITE_DISTRICT_PERFORMANCE_REPORT_SLICE =
  process.env.REACT_APP_SUPERSET_IRS_LITE_DISTRICT_PERFORMANCE_REPORT_SLICE || '0';
export type SUPERSET_IRS_LITE_DISTRICT_PERFORMANCE_REPORT_SLICE = typeof SUPERSET_IRS_LITE_DISTRICT_PERFORMANCE_REPORT_SLICE;

export const SUPERSET_IRS_LITE_DATA_COLLECTORS_PERFORMANCE_REPORT_SLICE =
  process.env.REACT_APP_SUPERSET_IRS_LITE_DATA_COLLECTORS_PERFORMANCE_REPORT_SLICE || '0';
export type SUPERSET_IRS_LITE_DATA_COLLECTORS_PERFORMANCE_REPORT_SLICE = typeof SUPERSET_IRS_LITE_DATA_COLLECTORS_PERFORMANCE_REPORT_SLICE;

export const SUPERSET_IRS_LITE_SOP_PERFORMANCE_REPORT_SLICE =
  process.env.REACT_APP_SUPERSET_IRS_LITE_SOP_PERFORMANCE_REPORT_SLICE || '0';
export type SUPERSET_IRS_LITE_SOP_PERFORMANCE_REPORT_SLICE = typeof SUPERSET_IRS_LITE_SOP_PERFORMANCE_REPORT_SLICE;

export const SUPERSET_IRS_LITE_SOP_BY_DATE_PERFORMANCE_REPORT_SLICE =
  process.env.REACT_APP_SUPERSET_IRS_LITE_SOP_BY_DATE_PERFORMANCE_REPORT_SLICE || '0';
export type SUPERSET_IRS_LITE_SOP_BY_DATE_PERFORMANCE_REPORT_SLICE = typeof SUPERSET_IRS_LITE_SOP_BY_DATE_PERFORMANCE_REPORT_SLICE;
...
export const ENABLE_IRS_LITE_MOPUP_REPORTING =
  process.env.REACT_APP_ENABLE_IRS_LITE_MOPUP_REPORTING;
export type ENABLE_IRS_LITE_MOPUP_REPORTING = typeof ENABLE_IRS_LITE_MOPUP_REPORTING;

export const SUPERSET_IRS_LITE_MOPUP_REPORTING_JURISDICTIONS_DATA_SLICES =
  process.env.REACT_APP_SUPERSET_IRS_LITE_MOPUP_REPORTING_JURISDICTIONS_DATA_SLICES ?? '0';
export type SUPERSET_IRS_LITE_MOPUP_REPORTING_JURISDICTIONS_DATA_SLICES = typeof SUPERSET_IRS_LITE_MOPUP_REPORTING_JURISDICTIONS_DATA_SLICES;

export const SUPERSET_IRS_LITE_MOPUP_REPORTING_JURISDICTIONS_FOCUS_AREA_LEVEL =
  process.env.REACT_APP_SUPERSET_IRS_LITE_MOPUP_REPORTING_JURISDICTIONS_FOCUS_AREA_LEVEL ?? '0';
export type SUPERSET_IRS_LITE_MOPUP_REPORTING_JURISDICTIONS_FOCUS_AREA_LEVEL = typeof SUPERSET_IRS_LITE_MOPUP_REPORTING_JURISDICTIONS_FOCUS_AREA_LEVEL;
