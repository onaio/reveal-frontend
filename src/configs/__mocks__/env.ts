...
export const SUPERSET_MDA_LITE_REPORTING_INDICATOR_ROWS = 'kenya2021';
...
export const ENABLED_JURISDICTION_METADATA_IDENTIFIER_OPTIONS = 'COVERAGE,POPULATION,RISK,STRUCTURE,TARGET,OTHER_POPULATION'.split(
  ','
);
...
export const REVOKE_COMPLETE_AND_RETIRED_PLANS_TEAM_ASSIGNMENTS = true;

export const OPENSRP_MAX_PLANS_PER_REQUEST = 2000;

export const PLAN_TEAM_ASSIGNMENT_EXPIRY_YEARS = 0;

export const SHOW_INDEFINITE_PLAN_TEAM_ASSIGNMENTS = false;
