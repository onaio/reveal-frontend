...
describe('components/MDA/Lite/Reports/cddReport/supervisor', () => {
  ...
  it('renders correctly', async () => {
    ...
    expect(
      ...
      '/intervention/mda-lite/cdd/report/5e396185-6094-4817-9dd4-24bcbbc698b0/9ec52632-7bfb-40f5-9ef7-8804627a65cb/emuhayaSupervisor1:emuhaya Supervisor 1'
    );
    expect(
      row2
        .find('.td a')
      ...
      '/intervention/mda-lite/cdd/report/5e396185-6094-4817-9dd4-24bcbbc698b0/9ec52632-7bfb-40f5-9ef7-8804627a65cb/UHS3:UpperHillWard Supervisor 3'
    );
  });
});
