...
describe('components/IRS Reports/JurisdictionReportLite', () => {
  ...
  it('drills down correctly', async () => {
    ...
    expect(wrapper.find('h3.page-title').text()).toEqual(
      'IRS Lite Reporting: IRS 2019-09-05 TEST: Zambia'
    );
    expect(wrapper.find('DrillDownTable').props()).toMatchSnapshot({
      columns: expect.any(Object) /** just for purposes of making snapshot smaller */,
      data: expect.any(Object) /** just for purposes of making snapshot smaller */,
    ...
    expect(wrapper.find('h3.page-title').text()).toEqual(
      'IRS Lite Reporting: IRS 2019-09-05 TEST: Lusaka'
    );
    expect(wrapper.find('DrillDownTable').props()).toMatchSnapshot({
      columns: expect.any(Object) /** just for purposes of making snapshot smaller */,
      data: expect.any(Object) /** just for purposes of making snapshot smaller */,
    ...
    expect(wrapper.find('h3.page-title').text()).toEqual(
      'IRS Lite Reporting: IRS 2019-09-05 TEST: Lusaka_Test'
    );
    expect(wrapper.find('DrillDownTable').props()).toMatchSnapshot({
      columns: expect.any(Object) /** just for purposes of making snapshot smaller */,
      data: expect.any(Object) /** just for purposes of making snapshot smaller */,
    ...
    expect(wrapper.find('DrillDownTable a').map(e => e.props().href)).toEqual([
      '/intervention/irs-lite/report/727c3d40-e118-564a-b231-aac633e6abce/2bf9915d-8725-4061-983d-5938802ac0f0',
      '/intervention/irs-lite/report/727c3d40-e118-564a-b231-aac633e6abce/ed2391d9-f91a-473e-af1c-65b18aa49e38',
    ]);
    expect(
    ...
    expect(wrapper.find('h3.page-title').text()).toEqual(
      'IRS Lite Reporting: IRS 2019-09-05 TEST: Lusaka HFC'
    );
    expect(wrapper.find('DrillDownTable').props()).toMatchSnapshot({
      columns: expect.any(Object) /** just for purposes of making snapshot smaller */,
      data: expect.any(Object) /** just for purposes of making snapshot smaller */,
