...
jest.mock('../../../../../configs/env', () => ({
  SUPERSET_IRS_LITE_REPORTING_FOCUS_AREAS_COLUMNS: 'namibia2019',
  SUPERSET_IRS_LITE_REPORTING_INDICATOR_ROWS: 'namibia2019',
  SUPERSET_IRS_LITE_REPORTING_INDICATOR_STOPS: 'namibia2019',
  SUPERSET_IRS_LITE_REPORTING_JURISDICTIONS_COLUMNS: 'namibia2019',
...
describe('Namibia configs: components/IRS Lite Reports/JurisdictionReportLite', () => {
  beforeEach(() => {
    jest.resetAllMocks();
  });
  ...
  it('Namibia configs: renders correctly', async () => {
    ...
    //
    //
    //// Commented out because I believe this is hitting a live system where the data doesn't exist.
    //
    //
  ...
  it('drills down correctly', async () => {
    ...
    const baseURL = `${REPORT_IRS_LITE_PLAN_URL}/727c3d40-e118-564a-b231-aac633e6abce`;
    ...
    expect(wrapper.find('h3.page-title').text()).toEqual(
      'IRS Lite Reporting: IRS 2019-09-05 TEST: Namibia'
    );
    expect(wrapper.find('DrillDownTable').props()).toMatchSnapshot({
      columns: expect.any(Object) /** just for purposes of making snapshot smaller */,
      data: expect.any(Object) /** just for purposes of making snapshot smaller */,
