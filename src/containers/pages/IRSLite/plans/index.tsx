...
import { IRS_LITE_PLANS } from '../../../../configs/lang';
import { QUERY_PARAM_TITLE, REPORT_IRS_LITE_PLAN_URL } from '../../../../constants';
...
const defaultProps: GenericPlanListProps = {
  ...
  pageTitle: IRS_LITE_PLANS,
  pageUrl: REPORT_IRS_LITE_PLAN_URL,
  plans: [],
  service: supersetFetch,
  supersetReportingSlice: SUPERSET_IRS_LITE_REPORTING_PLANS_SLICE,
};
...
const ConnectedIRSLitePlansList = connect(mapStateToProps, mapDispatchToProps)(IRSPlansList);

export default ConnectedIRSLitePlansList;
